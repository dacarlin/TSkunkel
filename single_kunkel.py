...
def single_kunkel( p, params ):
    ...
    for i in ML: # Kunkel indexes
        print i

    #
    # class ContainerGroup:
    #     def __init__( self, n_cont, cont_type, storage ):
    #         self.container_group = []
    #         for i in range( n_cont ):
    #             my_ref = p.ref( 'cont_{}'.format( i ), None, cont_type, storage )
    #             self.container_group.append( my_ref )
    #
    #
    #
    #
